...
toolbar-agent-task = New Agent Task
toolbar-refresh = Refresh
toolbar-settings = Settings
toolbar-busy = Working…

# ===== External Agent sessions =====
agent-task-title = New Agent Task
agent-task-placeholder = Describe the task for the coding agent…
agent-task-empty = Enter a task before starting an Agent.
agent-profile-label = Agent
agent-context-none = No review selection
agent-review-tab = Review
agent-new-task = New Agent Task
agent-start = Start Agent
agent-cancel = Cancel
agent-profile-invalid = The selected Agent profile is invalid.
agent-start-failed = Could not start Agent: { $error }
agent-status-starting = Starting
agent-status-running = Running
agent-status-exited = Exited ({ $code })
agent-status-exited-unknown = Exited
agent-status-failed = Failed: { $error }
agent-activity-now = Just now
agent-activity-seconds = { $seconds }s ago
agent-activity-finished = Finished
agent-shared-tree-title = Share the working tree?
agent-shared-tree-warning = Another Agent session is still running. Both sessions use this repository's working tree and may overwrite or conflict with each other.
agent-close-title = Stop Agent session?
agent-close-warning = This will terminate the running Agent process and its child processes.
agent-close-confirm = Stop session
workspace-close-title = Stop active Agent sessions?
workspace-close-warning = { $count } Agent session(s) are still running. Closing Augur Git will terminate them and their child processes.
workspace-tab-close-title = Stop Agent sessions in this tab?
workspace-tab-close-warning = Tab “{ $tab }” has { $count } running Agent session(s). Closing it will terminate them and their child processes.
...
agent-default-profile-title = Default Agent profile
